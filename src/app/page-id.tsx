            ...
            <section className="kelebihan">
              <div className="container">
                <div className="title-flex">
                  <p>
                    Kelebihan Memilih Vaksin di Rumah dari{" "}
                ...
                <div className="list-benefits">
                  ...
                  <div className="items-benefits">
                    ...
                    />
                    <p>
                      Konsultasi dengan dokter lebih leluasa, bisa tanya apa
                      saja
                    </p>
                  </div>
                  <div className="items-benefits">
              ...
              <div className="container">
                ...
                <div className="list-benefits">
                  ...
                  <div className="items-benefits">
                    ...
                    />
                    <p>
                      Melindungi anak dari penyakit serius seperti polio,
                      campak, rubela, hepatitis, dll
                    </p>
                  </div>
                  <div className="items-benefits">
                    <img
                    ...
                    />
                    <p>
                      Mencegah infeksi penyebaran penyakit yang dapat menular ke
                      orang lain
                    </p>
                  </div>
                </div>
                ...
                <div className="container">
                  ...
                  <div className="text-center mt-4">
                    <a
                      ...
                      download
                    >
                      <i className="mdi mdi-download"></i> Jadwal Vaksinasi Anak
                      Umur 0-18 Tahun
                    </a>
                  </div>
                </div>
                ...
                <div className="container">
                  ...
                  <div className="text-center mt-4">
                    <a
                      ...
                      download
                    >
                      <i className="mdi mdi-download"></i> Download Jenis Vaksin
                      dan Harga
                    </a>
                  </div>
                </div>
              ...
              <section className="jadwal-imunisasi">
                <div className="container">
                  <p className="text-center fs-18 fw-bold">
                    Jadwal Imunisasi Anak IDAI 2023
                  </p>
                  <img
              ...
              <div className="row mb-3 g-3">
                ...
                <div className="col-md-4">
                  ...
                  >
                    ...
                    <option value="Vaksin Yellow Fever">
                      Vaksin Yellow Fever
                    </option>
